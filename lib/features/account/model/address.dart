...
class AddressDomain {
  ...
  static final List<AddressDomain> recentSearches = [
    AddressDomain(Icons.location_on, "City Park Museum", "656 East Depot Lane Bronx, New York 10460"),
    AddressDomain(Icons.location_on, "Padeum Street", "9922 West Linda Rd. Rochester, New York 14609"),
