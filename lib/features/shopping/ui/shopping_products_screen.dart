...
class _ShoppingProductsState extends State<ShoppingProducts>
  ...
  void initState() {
    ...
    _controller =
        TabController(
          length: CategoryDomain.ecommerceList[0].subCategories!.length,
          vsync: this,
        )..addListener(() {
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              ...
              children: [
                ...List.generate(
                  CategoryDomain.ecommerceList.first.subCategories!.length,
                  (categoryIndex) {
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Text(
                                    r"$" +
                                        product.items[index].price.toString(),
